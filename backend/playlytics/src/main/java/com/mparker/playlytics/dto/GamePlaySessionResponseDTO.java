...
public record GamePlaySessionResponseDTO(Instant sessionDateTime, ScoringModel scoringModel, Game game, Set<SessionParticipant> sessionParticipants, Set<SessionTeam> sessionTeams) {
}
